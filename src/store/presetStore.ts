...
export const usePresetStore = create<PresetState>((set, get) => ({
  presets: [
    {
      id: 'clean-cloudwalker',
      name: 'Clean Cloudwalker Apps',
      steps: [
        { type: 'DISABLE_PACKAGE', params: { packageName: 'tv.cloudwalker.profile' } },
        { type: 'DISABLE_PACKAGE', params: { packageName: 'tv.cloudwalker.channels' } },
